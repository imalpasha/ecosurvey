 ...
 * {@link GalleryActivityV2#PHOTOS} or {@link GalleryActivityV2#VIDEO} in
 * {@link Activity#onActivityResult}
 */
public class GalleryActivityV2 extends MainFragmentActivity implements ActionBarLayout.ActionBarLayoutDelegate {
    ...
    public static void openActivity(Activity activity, int requestCode, GalleryConfig config) {
        Intent intent = new Intent(activity, GalleryActivityV2.class);
