...
public class SharedPrefManager {
    ...
    public static final String NOTIFICATION = "Y";
    ...
    public HashMap<String, String> getBackground() {
        HashMap<String, String> init = new HashMap<String, String>();
        init.put(BACKGROUND, _sharedPrefs.getString(BACKGROUND, null));
        return init;
    }
    ...
    public void setNotification(String notify) {
        _prefsEditor.putString(NOTIFICATION, notify);
        _prefsEditor.apply();
    }

    public HashMap<String, String> getNotify() {
        HashMap<String, String> init = new HashMap<String, String>();
        init.put(NOTIFICATION, _sharedPrefs.getString(NOTIFICATION, null));
        return init;
    }
    ...
    public void setBackground(String back) {
        _prefsEditor.putString(BACKGROUND, back);
        _prefsEditor.apply();
    }
